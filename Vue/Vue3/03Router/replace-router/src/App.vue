...
<!--      <RouterLink :to="{path:'/about'}" active-class="active">关于</RouterLink>-->
      ...
      <RouterLink replace :to="{name:'sy'}" active-class="active">首页</RouterLink>
      <RouterLink :to="{name:'xw'}" active-class="active">新闻</RouterLink>
      <RouterLink replace :to="{name:'gy'}" active-class="active">关于</RouterLink>
    </div>
    <!-- 展示区 -->
